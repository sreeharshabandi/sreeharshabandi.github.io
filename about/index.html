...
<header class="panel-cover" style="background-image: url(/jekyll-uno/images/bk1.jpg)">
  <div class="panel-main">
    ...
    <div class="panel-main__content">
        <a href="/jekyll-uno/" title="link to home">
        ...
        <div class="navigation-wrapper">
          ...
          <nav class="cover-navigation cover-navigation--primary">
            <ul class="navigation">
              <li class="navigation__item"><a href="/jekyll-uno/#blog" title="link to Sreeharsha Bandi blog" class="blog-button">Blog</a></li>
              <li class="navigation__item"><a href="/jekyll-uno/about/" title="link to Sreeharsha Bandi about" class="blog-button">About</a></li>
            </ul>
          </nav>
